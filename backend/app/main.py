...
from app.api.routes import project_policy, email_templates
...
# include routers
for r in [auth.router, projects.router, project_policy.router, email_templates.router, tasks.router, users.router, dashboard.router, settings_routes.router, agent.router]:
